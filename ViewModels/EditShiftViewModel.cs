...
namespace LogInForm.ViewModels
{
    public class EditShiftViewModel: ViewModelBase
    {
        ...
        private bool isVerifiedSecondShift;

        private bool isVerifiedAbriviatureName;

        private bool isVerifiedFirstShift;

        #endregion

        #region Constructor

        public EditShiftViewModel(Shift shift, List<string> shiftAbriviaturesName)
        {
            ...
            this.Abriviature = shift.Abriviature;
            this.Name = shift.Name;
            this.FirstStartingHour = shift.FirstStartingHour;
            this.FirstStartingMinute = shift.FirstStartingMinute;
            this.FirstClosingHour = shift.FirstClosingHour;
            this.FirstClosingMinute = shift.FirstClosingMinute;
            this.SecondStartingHour = shift.SecondStartingHour;
            this.SecondStartingMinute = shift.SecondStartingMinute;
            this.SecondClosingHour = shift.SecondClosingHour;
            this.SecondClosingMinute = shift.SecondClosingMinute;
            this.BreakFirstPeriod = shift.BreakFirstPeriod;
            this.BreakSecondPeriod = shift.BreakSecondPeriod;

            this.AbriviatureNames = shiftAbriviaturesName;
            this.UpdateShiftCommand = new Command(this.OnUpdateShiftCommandExecute);
        }
        ...
        public Shift UpdatedShift
        {
            get { return GetValue<Shift>(NewShiftProperty); }
            set { SetValue(NewShiftProperty, value); }
        }
        public static readonly PropertyData NewShiftProperty = RegisterProperty(nameof(UpdatedShift), typeof(Shift), null);
        ...
        public Command UpdateShiftCommand { get; private set; }
        private void OnUpdateShiftCommandExecute()
        {
